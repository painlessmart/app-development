...
enum VaildatorFactory {
    static func validatorFor(type: ValidatorType) -> ValidatorConvertible {
        ...
        case .rePassword(let oldPassword): return RePasswordValidator(oldPassword)
        }
    }
}
...
struct RePasswordValidator: ValidatorConvertible {
    ...
    func validated(_ value: String) throws -> String {
        guard value == password else {throw ValidationError("The password and confirmation password do not match")}
        return value
    }
}
